                        ...
                        <SvgIcon
                                                    ...
                                                    onClick={() => {
                                                        if (questaoAberta.edition) {
                                                            if (questaoAberta.assunto === "" || questaoAberta.enunciado === "") {
                    ...
                    <div key={index} className="questao">
                        ...
                        {!questaoFechada.edition && questaoFechada.enunciado}
                            {questaoFechada.edition && (
                                                    <TextField
                                                        id="standard-basic"
                                                        label={"Enuncado Atual: " + questaoFechada.enunciado}
                                                        variant="outlined"
                                                        fullWidth
                                                        value={newenunciado}
                        ...
                        {!questaoFechada.edition&& questaoFechada.assunto}
                            {questaoFechada.edition && (
                                                    <TextField
                                                        id="standard-basic"
                                                        label={"Assunto Atual: " + questaoFechada.assunto}
                                                        variant="outlined"
                                                        fullWidth
                                                        value={newassunto}
                        ...
                        <h5>A - 
                            ...
                            {questaoFechada.edition && (
                                                    <TextField
                                                        id="standard-basic"
                                                        label={"Letra A: " + alternativas[0][0]}
                                                        variant="outlined"
                                                        fullWidth
                                                        value={alternativa0}
                        ...
                        {!questaoFechada.edition && questaoFechada.alternativas[1]}
                            {questaoFechada.edition && (
                                                    <TextField
                                                        id="standard-basic"
                                                        label={"Letra B: " + alternativas[0][1]}
                                                        variant="outlined"
                                                        fullWidth
                                                        value={alternativa1}
                        ...
                        {!questaoFechada.edition && questaoFechada.alternativas[2]}
                            {questaoFechada.edition && (
                                                    <TextField
                                                        id="standard-basic"
                                                        label={"Letra C: " + alternativas[0][2]}
                                                        variant="outlined"
                                                        fullWidth
                                                        value={alternativa2}
                        ...
                        {!questaoFechada.edition && questaoFechada.alternativas[3]}
                            {questaoFechada.edition && (
                                                    <TextField
                                                        id="standard-basic"
                                                        label={"Letra D: " + alternativas[0][3]}
                                                        variant="outlined"
                                                        fullWidth
                                                        value={alternativa3}
                        ...
                        {!questaoFechada.edition && questaoFechada.alternativas[4]}
                            {questaoFechada.edition && (
                                                    <TextField
                                                        id="standard-basic"
                                                        label={"Letra E: " + alternativas[0][4]}
                                                        variant="outlined"
                                                        fullWidth
                                                        value={alternativa4}
                        ...
                        {questaoFechada.edition && (
                            <TextField
                            id="standard-basic"
                            label={"Resposta Atual: " + questaoFechada.resposta_correta}
                            variant="outlined"
                            fullWidth
                        ...
                        <SvgIcon
                                                    ...
                                                    onClick={() => {
                                                        if (questaoFechada.edition) {
                                                            ...
                                                            let alternativaslenght = 0;
                                                            alternativas.map((alternativa) => {
                                                                if (alternativa === "") {
                                                                    alternativaslenght += 1;
                                                                }
                                                                return (null);
                                                            })
                                                            if (enunciado !== "" && assunto !== "" && resposta_correta !== "" && alternativaslenght === 0 ) {
                                                                alternativaslenght = 0;
                            ...
                            <h4>
                                {!questaoVF.edition && questaoVF.enunciado}
                                    {questaoVF.edition && (
                                                            <TextField
                                                                id="standard-basic"
                                                                label={"Enuncado Atual: " + questaoVF.enunciado}
                                                                variant="outlined"
                                                                fullWidth
                                ...
                                {!questaoVF.edition&& questaoVF.assunto}
                                    {questaoVF.edition && (
                                                            <TextField
                                                                id="standard-basic"
                                                                label={"Assunto Atual: " + questaoVF.assunto}
                                                                variant="outlined"
                                                                fullWidth
                                                                value={newassuntovf}
                                ...
                                <h5>[] - 
                                    ...
                                    {questaoVF.edition && (
                                                            <TextField
                                                                className="widthVF"
                                                                id="standard-basic"
                                                                label={"Primeira alternativa atual: " + alternativas[0][0]}
                                                                variant="outlined"
                                ...
                                {!questaoVF.edition && questaoVF.alternativas[1]}
                                    {questaoVF.edition && (
                                                            <TextField
                                                                className="widthVF"
                                                                id="standard-basic"
                                                                label={"Segunda alternativa atual: " + alternativas[0][1]}
                                                                variant="outlined"
                                ...
                                {!questaoVF.edition && questaoVF.alternativas[2]}
                                    {questaoVF.edition && (
                                                            <TextField
                                                                className="widthVF"
                                                                id="standard-basic"
                                                                label={"Terceira alternativa atual: " + alternativas[0][2]}
                                                                variant="outlined"
                                ...
                                {!questaoVF.edition && questaoVF.alternativas[3]}
                                    {questaoVF.edition && (
                                                            <TextField
                                                                className="widthVF"
                                                                id="standard-basic"
                                                                label={"Quarta alternativa atual: " + alternativas[0][3]}
                                                                variant="outlined"
                                ...
                                {!questaoVF.edition && questaoVF.alternativas[4]}
                                    {questaoVF.edition && (
                                                            <TextField
                                                                className="widthVF"
                                                                id="standard-basic"
                                                                label={"Quinta alternativa atual: " + alternativas[0][4]}
                                                                variant="outlined"
                        ...
                        <SvgIcon
                                                    ...
                                                    onClick={() => {
                                                        if (questaoVF.edition) {
                                                            ...
                                                            if (enunciado !== "" && assunto !== "" && alternativaslenght === 0 ) {
                                                                alternativaslenght = 0;
